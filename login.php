  ...
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
     ...
     <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#Docter">Docters</a>
     </li>
    </ul> 
...
<div class="tab-pane container fade" id="Docter">
         <form action="file/docterLogin.php" class="login-form" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Docter Email</label>
          <input type="email" name="demail" placeholder="Docter Email" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Docter Password</label>
          <input type="password" name="dpassword" placeholder="Docter Password" class="form-control mb-4">
